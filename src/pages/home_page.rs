...
use crate::{
    components::{JobCard, TitleHeader},
    model::job::{jobs_mock_data, Job},
};
...
pub fn HomePage() -> impl IntoView {
    ...
    let who_am_i_ref = create_section_animation();
    let what_do_i_do_ref = create_section_animation();
    let my_last_jobs_ref = create_section_animation();
    let cool_stuff_ref = create_section_animation();
    let be_rust_ref = create_section_animation();
    let be_cpp_ref = create_section_animation();
    let ray_man_ref = create_section_animation();
        ...
        <main>
            <section node_ref=who_am_i_ref class="hidden">
                ...
                <p>
                    ...
                    " as a full-stack developer with Angular and J*va."
                    "I'm also a studying Computer Science at "
                    <a href="https://cdv.pl" target="_blank">"Collegium Da Vinci"</a>
                    " in Poznań, although I have "
                    {years_str}
                    " of experience in the industry. "
                    "I'm a constant learner and I'm always trying to improve my skills. "
                    "I'm brought to the programming world by my passion for video games, so "
                    "it's no surprise that I'm also a hobbyist game developer. (Well, I'm trying to be) "
                    "I absolutely love Vulkan, Rust and C++, and I hope the day will come when "
                    "I'll be able to leave the J*va in the past."
                </p>
                <p>
                    "I'm also a huge fan of Linux and open source software. "
                    "I'm using Linux as my main OS for the last 5 years and I'm not going back. "
                    "I'm using Arch btw. "
                </p>
                <p>
                    "Also, sometimes I "
            ...
            <section node_ref=what_do_i_do_ref class="hidden">
                ...
                <p>
                    ...
                    "programming and Computer Science as much as I can. "
                    "On spare time I'm playing guitar, video games, and if "
                    "I'm particularly energized, I'm working on my own projects, "
                    "web dev and what not. "
                    "For example for the last few months I've been working on "
                    "a game engine completely from scratch. "
                    "I'm also a big fan of Rust and I'm trying to use it whenever I can, "
            ...
            <section node_ref=cool_stuff_ref class="hidden">
                ...
                <p>
                    ...
                    "Can't really say if that counts as \"cool stuff\" though, but anyway "
                    "I'm somewhat proud of them as they show me how much I've learned over the years. "
            ...
            <section node_ref=be_rust_ref class="hidden">
                ...
                <p>
                    "A game engine I'm working on. It's written in Rust and uses Vulkan for rendering. "
                    "I'm trying to make it as much from scratch as possible and reasonable. "
                    "Also, it's worth mentioning that I'm not doing a general-purpose engine, "
                    "but rather a very specific one. For a game I have in mind."
                    "Definitely not a production-ready engine, but it's still a great learning experience "
                    "and a lot of fun. "
                </p>
                <p>
            ...
            <section node_ref=ray_man_ref class="hidden">
                ...
                <p>
                    "A funny little software raytracer I've made. "
                    "It's written in C++ uses ImGui for UI and "
                    "Walnut as a template for the project. "
                    "It's not anything special, but it was fun to make and pretty interesting "
            ...
            <section node_ref=be_cpp_ref class="hidden">
                ...
                <p>
                    "This is the abandoned C++ version of the engine. "
                    "It's where I started learning about game engines and graphics programming. "
                    "And then I've decided to " <i>"rewrite it in Rust™"</i> ". "
                    "Also, I've got unsatisfied with the design and architecture of the engine, "
                    "so started anew with the knowledge I've gained. "
                    "And I thought it would be more fun to write it in Rust (it is). "
                    "Also, it uses OpenGL, which is not as fun as Vulkan. "
                </p>
            </section>
        </main>
