...
pub fn jobs_mock_data() -> [Job; 3] {
    [
        Job {
            title: "Middle Full-Stack Developer".into(),
            company_name: "Astek Polska".into(),
            company_link: Some("https://astek.pl".into()),
            description: r#"Huge project for a big client in the healthcare industry.
                        The product is in development and use for the last 20 years.
                        I'm working on the Angular frontend and J*va backend."#
                .into(),
        ...
        Job {
            ...
            description: r#"Multiple projects for multiple clients.
                        Mostly frontend work with Angular, but also
                        some backend work with Node and .Net"#
                .into(),
        ...
        Job {
            ...
            company_link: None,
            description: r#"A lot of small projects for numerous clients.
                        Mostly frontend work with React and Angular, but also a lot of
                        general web dev work with Node, Express, .Net, Apache, Nginx, WordPress, etc.
                        You know how it goes on freelance."#.into(),
            location: "Belarus, Remote".into(),
